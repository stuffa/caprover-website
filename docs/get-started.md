...
rpi version of ubuntu do not include support for vxlan. it can be added with
sudo apt install linux-modules-extra-rpi
Also the core version of Ubuntu do not include support to run/boot of SSD - use ubintu server instead 
